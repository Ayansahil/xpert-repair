...
const BrandsPage = () => {
  return (
    <>
      <Helmet>
        <title>Appliance Brands We Repair - Samsung, LG, Whirlpool, Bosch & More | Expert Repair</title>
        ...
        <link rel="canonical" href="https://expertrepair.com/brands" />
        <meta property="og:title" content="Major Appliance Brands We Repair - Expert Repair" />
        ...
        <meta property="og:url" content="https://expertrepair.com/brands" />
      </Helmet>
      <Brands />
    </>
  );
